...
System tray, burn rate, quota prediction, alerts, thread token usage, project/model aggregation,
history dashboard, and full Settings are not implemented yet.
